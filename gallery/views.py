...
#sightengine api
client = SightengineClient('628161072', 'W8E8HyAv5zmp8TBsLEia')
output = client.check('nudity','wad','offensive').set_url('https://sightengine.com/assets/img/examples/example7.jpg')
